...
| URL | Title | Description focus | Robots |
|---|---|---|---|
...
| `/404.html` | Page Not Found \| NPO Grant Writing | Recovery navigation | noindex |

Every indexable page has:

- one unique title;
- one unique meta description;
- an HTTPS canonical URL on `www.npograntwriting.com`;
- Open Graph and Twitter card metadata;
- social image dimensions and alt text;
- one H1 and semantic heading order;
- shared professional-service structured data.

Additional structured data:

- Home: `ProfessionalService` and FAQ content
- About: `AboutPage` with Brendan Bradley and Heidi Roux as people
- Contact: `ContactPage`

The sitemap contains only the four primary indexable URLs and excludes Privacy, Thank You, 404, and redirect fallback pages. `robots.txt` permits crawling and points to the sitemap.
